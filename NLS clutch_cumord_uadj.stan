...
model {
  ...
  vector[N] mu_h = rep_vector(0,N);
  vector[N] mu_s = rep_vector(mu_s_0,N) ;
  vector[N] mu_m = rep_vector(mu_m_0,N) ;
  ...
  for (n in 1 : N) {
    mu_h[n] +=   b_h[1] * I_c_mu[id[n]] + b_h[2] * I_c_disc[id[n]]
               ...
               + q_h[3] * (I_c_mu[id[n]] * I_c_disc[id[n]]);
  }
  ...
  for (n in 1 : N) {
    mu_s[n] +=   b_s[1] * I_c_mu[id[n]] + b_s[2] * I_c_disc[id[n]]
               ...
               + q_s[3] * (I_c_mu[id[n]] * I_c_disc[id[n]]);
  }
  ...
  for (n in 1 : N) {
    mu_m[n] +=   b_m[1] * I_c_mu[id[n]] + b_m[2] * I_c_disc[id[n]]
               ...
               + q_m[3] * (I_c_mu[id[n]] * I_c_disc[id[n]]);
  }
